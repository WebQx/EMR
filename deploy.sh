...
if [[ $REPO_URL == *"github.com"* ]]; then
    ...
    echo "=============================================="
    echo -e "${BLUE}🌍 Your WebQx Global Healthcare Platform is available at:${NC}"
    echo -e "${GREEN}   Main Platform: ${PAGES_URL}${NC}"
    echo -e "${GREEN}   24/7 Healthcare: ${PAGES_URL}telehealth-24-7-global.html${NC}"
    echo -e "${GREEN}   Patient Portal: ${PAGES_URL}patient-portal/${NC}"
    echo -e "${GREEN}   Provider Portal: ${PAGES_URL}provider/${NC}"
    echo ""
