...
use WebQX EMR\Common\Twig\TwigContainer;
use WebQX EMR\Events\Core\TemplatePageEvent;
use WebQX EMR\Services\FacilityService;
use WebQX EMR\Services\LogoService;
...
$regTranslations = json_encode(array(
    'title' => xla('WebQX EMR Product Registration'),
    'pleaseProvideValidEmail' => xla('Please provide a valid email address'),
    'success' => xla('Success'),
    'registeredSuccess' => xla('Your installation of WebQX EMR has been registered'),
    'submit' => xla('Submit'),
